...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './people.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PEOPLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PEOPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PEOPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PEOPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PEOPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PEOPLE actions', async () => {
      const expectedActions = [
        {
