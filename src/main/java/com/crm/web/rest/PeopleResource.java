...
/**
 * REST controller for managing {@link com.crm.domain.People}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<People> result = peopleRepository
            ...
            .map(existingPeople -> {
                if (people.getPeopleId() != null) {
                    existingPeople.setPeopleId(people.getPeopleId());
                }
                if (people.getPersonalData() != null) {
                    existingPeople.setPersonalData(people.getPersonalData());
                }
                if (people.getDemographicData() != null) {
                    existingPeople.setDemographicData(people.getDemographicData());
                }
                if (people.getDateOfContact() != null) {
                    existingPeople.setDateOfContact(people.getDateOfContact());
                }
                if (people.getEmployee() != null) {
                    existingPeople.setEmployee(people.getEmployee());
                }
                if (people.getReason() != null) {
                    existingPeople.setReason(people.getReason());
                }
                if (people.getDescription() != null) {
                    existingPeople.setDescription(people.getDescription());
                }
                if (people.getAction() != null) {
                    existingPeople.setAction(people.getAction());
                }
